...
var services = [
  ...
  },
  {
    ...
    features: [
      { label: '24/7 care and supervision by our pet care attendants' },
      { label: '24/7 air-conditioned accommodation' },
      { label: 'CCTV access for added peace of mind' },
      { label: 'Unlimited supply of purified drinking water' },
      { label: 'Free access to the indoor play park' },
      { label: 'Use of in-house appliances, as needed' },
    ],
